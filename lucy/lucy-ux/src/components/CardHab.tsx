...
export default function CardPDI(props: {hab: Habitaciones}) {
            ...
            <div class="flex justify-between items-center mt-4">
                <div class="flex flex-col items-start gap-2 w-full px-8 font-work">
                    ...
                    <div class="flex flex-col w-full justify-end items-end gap-4">
                        ...
                        <LucyButtonNoA onClick={() => {navigate("/" + props.hab.id, {replace: false})}} ButtonText={"Reservar"} ButtonBackground="lucy-primary" ButtonForeground="lucy-dark" ButtonSize="sm" ButtonIconSide="right" ButtonIcon={<ArrowRight />}/>
                    </div>
                </div>
            </div>
        </div>
