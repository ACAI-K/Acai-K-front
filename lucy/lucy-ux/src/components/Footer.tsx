    ...
    return (
        <footer class="bg-lucy-disabled text-lucy-primary py-12 px-8 mt-auto border-t border-lucy-dark/10">
            <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    <A href="/explorar">
                        <h4 class="font-work text-xl mb-4 font-semibold hover:text-lucy-light transition-colors">Explorar</h4>
                    </A>
                ...
                <div>
                    <A href="/explorar">
                        <h4 class="font-work text-xl mb-4 font-semibold hover:text-lucy-light transition-colors">Cuenta</h4>
                    </A>
                    <ul class="space-y-2 font-work text-[15px]">
                ...
                <div>
                    <A href="/hospedaje">
                        <h4 class="font-work text-xl mb-4 font-semibold hover:text-lucy-light transition-colors">Hospedaje</h4>
                    </A>
                    <ul class="space-y-2 font-work text-[15px]">
